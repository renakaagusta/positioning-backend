...
const pointCollections_1 = __importDefault(require("./api/pointCollections"));
const PointCollectionsService_1 = __importDefault(require("./services/firestore/PointCollectionsService"));
const pointCollections_2 = __importDefault(require("./validator/pointCollections"));
const reports_1 = __importDefault(require("./api/reports"));
const ReportsService_1 = __importDefault(require("./services/firestore/ReportsService"));
const reports_2 = __importDefault(require("./validator/reports"));
const routeCollections_1 = __importDefault(require("./api/routeCollections"));
const RouteCollectionsService_1 = __importDefault(require("./services/firestore/RouteCollectionsService"));
const routeCollections_2 = __importDefault(require("./validator/routeCollections"));
...
const init = function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pointCollectionsService = new PointCollectionsService_1.default();
        const reportsService = new ReportsService_1.default();
        const routeCollectionsService = new RouteCollectionsService_1.default();
        ...
        yield exports.server.register([
            ...
            {
                plugin: pointCollections_1.default,
                options: {
                    service: pointCollectionsService,
                    validator: pointCollections_2.default,
                },
            },
            {
                plugin: reports_1.default,
                options: {
                    service: reportsService,
                    validator: reports_2.default,
                },
            },
            {
                plugin: routeCollections_1.default,
                options: {
                    service: routeCollectionsService,
                    validator: routeCollections_2.default,
                },
            },
            {

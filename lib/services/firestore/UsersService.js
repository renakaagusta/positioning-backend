...
class UsersService {
    ...
    updateUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const hashedPassword = yield bcrypt_1.default.hash(user.password, 10);
            const result = yield this._firestore.collection('users').doc(user.id).update(Object.assign(Object.assign({}, user), { password: hashedPassword }));
            if (!result) {
                throw new InvariantError_1.default('User gagal diperbarui');
            }
            return user.id;
        });
    }
    deleteUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this._firestore.collection('users').doc(userId).delete();
            if (!result) {
                throw new InvariantError_1.default('User gagal dihapus');
            }
            return userId;
        });
    }
    ...
    getUserById(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this._firestore.collection('users').doc(userId).get();
            if (!result.id) {

...
class ReportsService {
    ...
    getCalculatedData() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const routeCollections = [];
            routeResult.docs.map((routeCollection) => routeCollections.push(Object.assign({ id: routeCollection.id }, routeCollection.data())));
            const calculatedData = yield new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                yield (0, routing_1.connector)(routeCollections[0], new Date().getTime()).then((calculatedData) => __awaiter(this, void 0, void 0, function* () { return resolve(calculatedData); }));
            }));

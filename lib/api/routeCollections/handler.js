...
class RouteCollectionsHandler {
    ...
    postRouteCollectionHandler(request, h) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const poinCollection = {
                    type: type,
                    data: data
                };
                const poinCollectionId = yield this._service.addRouteCollection(poinCollection);
    ...
    getRouteCollectionsHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            const poinCollections = yield this._service.getRouteCollectionList();
            return {
                status: 'success',
                data: {
                    poinCollections,
    ...
    getRouteCollectionByIdHandler(request, h) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const poinCollection = yield this._service.getRouteCollectionById(id);
                return {
                    status: 'success',
                    data: {
                        poinCollection,

...
class PointCollectionsHandler {
    ...
    postPointCollectionHandler(request, h) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const poinCollectionId = yield this._service.addPointCollection(poinCollection);
    ...
    getPointCollectionsHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            const poinCollections = yield this._service.getPointCollectionList();
            return {
                status: 'success',
                data: {
                    poinCollections,
    ...
    getPointCollectionByIdHandler(request, h) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const poinCollection = yield this._service.getPointCollectionById(id);
                return {
                    status: 'success',
                    data: {
                        poinCollection,
